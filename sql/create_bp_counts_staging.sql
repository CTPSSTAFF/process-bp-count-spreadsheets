-- Table: public.bp_counts_staging

-- DROP TABLE IF EXISTS public.bp_counts_staging;

CREATE TABLE IF NOT EXISTS public.bp_counts_staging
(
    id integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
    bp_loc_id integer,
    count_id integer,
    town character varying(30) COLLATE pg_catalog."default",
    facility_name character varying(50) COLLATE pg_catalog."default",
    description character varying(255) COLLATE pg_catalog."default",
    temperature integer,
    sky character varying(3) COLLATE pg_catalog."default",
